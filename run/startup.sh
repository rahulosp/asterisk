...
########Copying contents to remote storage############
cp -ar /assets/var/run/asterisk/* /var/run/asterisk/ && echo "Copied var run"
cp -ar /assets/etc/asterisk/* /etc/asterisk/ && echo "Copied etc"
cp -ar /assets/var/spool/asterisk/* /var/spool/asterisk/ && echo "Copied var spool"
cp -ar /assets/var/www/html/* /var/www/html/ && echo "Copied var www"
